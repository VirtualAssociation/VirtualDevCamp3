...
////// Lighting:
////// Emissive:
                float node_6607 = length((i.uv0*2.0+-1.0));
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float3 emissive = (((1.0 - node_6607)*_MainTex_var.rgb)*i.vertexColor.rgb*0.25);
